...
console.log("[E2E] Manual-handshake background loaded (Firefox)");
...
console.log(`[E2E] Using ${apiType} API for background script`);
...
async function ensureContentScript(tabId) {
  ...
  // Firefox MV2 uses tabs.executeScript instead of the MV3 scripting API.
